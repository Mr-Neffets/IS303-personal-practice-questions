...
INSTRUCTIONS:
-------------
You are building a simple tracker to check if you are on track with your
study goals.

1. Ask the user how many hours they studied today.
2. Convert the input to a float.
3. Compare whether the hours studied is at least 2.
4. Print out a sentence like: "Met goal? True" or "Met goal? False"
'''
