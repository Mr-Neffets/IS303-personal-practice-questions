...
INSTRUCTIONS:
-------------
You are helping to prepare name badges for a tech conference. Each badge
should display the person's full name and their company.

1. Create a variable for the person's first name.
2. Create a variable for the person's last name.
3. Create a variable for the company name.
4. Combine the names into one full name variable.
5. Use print() to display: "<Full Name> - <Company>"
'''
...
first_name = "Sarah"
last_name = "Nguyen"
company = "PixelCloud Inc"

full_name = first_name + " " + last_name
print(full_name + " - " + company)
