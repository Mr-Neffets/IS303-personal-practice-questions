...
INSTRUCTIONS:
-------------
You're building a basic student profile using a dictionary.

1. Create a dictionary called `student` with these key-value pairs:
   - "name": a string with your name
   - "major": a string for your major
   - "year": a string like "freshman", "sophomore", etc.
2. Print the whole dictionary.
3. Print just the student's major.
