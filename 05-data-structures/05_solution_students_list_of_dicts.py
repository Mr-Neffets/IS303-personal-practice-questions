...
INSTRUCTIONS:
-------------
You're building a list of student dictionaries for a small class.

1. Create a dictionary for student1 with keys: "name", "major"
2. Create a dictionary for student2 with the same keys.
3. Put both dictionaries into a list called `students`.
4. Print the entire list.
5. Print the major of the second student in the list.
'''
...
student1 = {"name": "Jane", "major": "Accounting"}
student2 = {"name": "Marcus", "major": "Marketing"}
