...
INSTRUCTIONS:
-------------
You are building a tool to check if a classroom seat is taken.

1. Create a nested list called `seats` representing 2 rows:
   - The first row has "empty", "taken", "empty"
   - The second row has "taken", "taken", "empty"
2. Ask the user for a row number (0 or 1).
3. Ask the user for a seat number (0 to 2).
4. Use an if statement to check if that seat is "taken".
5. Print "Sorry, seat is taken." or "Seat is available!"
'''
...
row = int(input("Enter a row number (0 or 1): "))
seat = int(input("Enter a seat number (0, 1, or 2): "))

if seats[row][seat] == "taken":
