...
INSTRUCTIONS:
-------------
You have a shopping list and want to number each item.

1. Use a for loop with enumerate to print each item and its number.
2. Print it like "1. Milk", "2. Eggs", etc.
'''
